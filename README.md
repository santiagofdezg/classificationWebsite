...
This project was built using **Python 3.7.3** and it depends on the following libraries: 
...
```
	...
	numpy==1.16.2
	scikit-learn==0.20.3
	(there might be other dependencies generated by these libraries)
```
